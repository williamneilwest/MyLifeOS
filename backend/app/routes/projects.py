...
def generate_example_projects() -> list[dict[str, object]]:
    return [
        ...
        {
            'name': 'AI Project Analysis System',
            'description': 'AI-assisted project diagnostics and next-step generation.',
            'type': 'example',
            'tags': ['ai', 'analysis', 'planning'],
            'tasks': [
                {
                    'title': 'Define AI analysis prompt schema',
                    'description': 'Structured project context and output contract for AI runs.',
                    'details': 'Created a prompt template that includes project metadata, task signals, and risk indicators. Added response shape constraints so Flask can parse AI output safely. This made generated recommendations consistent and actionable.',
                    'status': 'completed',
                    'priority': 'high',
                    'category': 'Backend',
                    'depends_on': [],
                ...
                {
                    'title': 'Integrate AI service client',
                    'description': 'Connected backend analysis routes to model inference APIs.',
                    'details': 'Implemented AI client calls with timeout and failure handling in Flask service layer. Added request tracing IDs to correlate model responses with project records. The app can now run repeatable project analyses through API calls.',
                    'status': 'completed',
                    'priority': 'high',
                    'category': 'Integration',
                    'depends_on': [],
                ...
                {
                    'title': 'Build analysis results interface',
                    'description': 'Rendered AI insights and recommendations in React.',
                    'details': 'Created a UI section for confidence, blockers, and suggested follow-up tasks. Used reusable card patterns to keep summaries readable on desktop and mobile. Teams can now review AI output in context with project status.',
                    'status': 'completed',
                    'priority': 'medium',
                    'category': 'Frontend',
                    'depends_on': [],
                ...
                {
                    'title': 'Add one-click task generation',
                    'description': 'Allowed users to materialize AI recommendations as tasks.',
                    'details': 'Connected recommendation cards to backend task creation endpoints with project scoping. Added optimistic UI states so generated tasks appear immediately in React. This shortened time from analysis to execution.',
                    'status': 'completed',
                    'priority': 'medium',
                    'category': 'Integration',
                    'depends_on': [],
                ...
                {
                    'title': 'Cache repeated analysis requests',
                    'description': 'Reduced duplicate AI calls for unchanged project state.',
                    'details': 'Stored hash signatures of project state and reused recent analysis payloads when no material changes were detected. Added expiration windows to keep insights fresh. This lowered model usage costs and improved response latency.',
                    'status': 'completed',
                    'priority': 'high',
                    'category': 'Optimization',
                    'depends_on': [],
                ...
                {
                    'title': 'Track analysis quality metrics',
                    'description': 'Measured recommendation usefulness and acceptance rates.',
                    'details': 'Logged user acceptance actions for generated recommendations and tracked conversion to completed tasks. Built summary endpoints for continuous prompt tuning. The feedback loop improved recommendation relevance over time.',
                    'status': 'completed',
                    'priority': 'low',
                    'category': 'Backend',
                    'depends_on': [],
