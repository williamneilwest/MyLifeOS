...
export type ModuleId = 'dashboard' | 'finance' | 'projects' | 'homelab' | 'tasks' | 'planning' | 'tools';
...
export const defaultActiveModules: ModuleId[] = ['dashboard', 'finance', 'projects', 'homelab', 'tasks', 'planning', 'tools'];
